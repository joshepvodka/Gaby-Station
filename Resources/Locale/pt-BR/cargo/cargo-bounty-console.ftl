...
bounty-console-flavor-left = Recompensas provenientes de negociantes locais sem escrúpulos.
bounty-console-flavor-right = v1.4

bounty-manifest-header = [font size=14][bold]Official manifesto de recompensa de carga[/bold] (ID#{$id})[/font]
bounty-manifest-list-start = Manifesto de item:
