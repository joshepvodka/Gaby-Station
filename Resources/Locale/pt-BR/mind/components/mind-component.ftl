...
comp-mind-examined-catatonic = { CAPITALIZE(PRONOME-ELE($ent)) } está totalmente { MAKEGENERO("catatônico", $ent) }. O estresse da vida no espaço deve ter sido demais. Qualquer recuperação é improvável.
