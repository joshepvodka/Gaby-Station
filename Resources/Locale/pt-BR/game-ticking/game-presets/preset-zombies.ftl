...
zombie-round-end-user-was-initial = - [color=plum]{ $name }[/color] ([color=gray]{ $username }[/color]) era um dos infectados iniciais.
...
zombie-round-end-amount-all = [color=darkred]Toda a tripulação se tornou zumbi![/color]
zombie-round-end-survivor-count =
    { $count ->
        [one] Restou apenas um sobrevivente:
       *[other] Restaram apenas { $count } sobreviventes:
    }
