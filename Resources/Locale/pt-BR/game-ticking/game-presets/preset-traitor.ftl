...
traitor-role-moreinfo = Encontre mais informações sobre seu papel no menu de personagem.
traitor-role-nouplink = Você não possui um uplink do Sindicato. Faça valer a pena.
traitor-role-allegiances = Suas alianças:
traitor-role-notes = Notas da sua empresa:
# menu de personagem
