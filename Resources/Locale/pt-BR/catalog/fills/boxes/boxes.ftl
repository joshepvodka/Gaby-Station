...
ent-BoxLighttube = caixa de tubos de luz
    .desc = Esta caixa tem um formato interno que permite apenas lâmpadas e tubos de luz caibam.
...
ent-BoxMesonScanners = caixa de óculos de engenheiro
    .desc = Uma caixa de óculos de engenheiro sobressalentes.

ent-BoxMRE = M.R.E.
    .desc = Uma caixa de rações militares excedentes de décadas atrás. Surpreendentemente, não está podre.
...
ent-BoxLeadLined = caixa de chumbo
    .desc = Esta caixa impede a transmissão de radiação.
...
ent-BoxDarts = caixa de dardos
    .desc = Esta caixa está cheia de dardos coloridos.
...
ent-BoxPillCanister = caixa de porta-comprimidos
    .desc = Uma caixa cheia de porta-comprimidos.

ent-BoxBottle = caixa de garrafas
    .desc = Uma caixa cheia de garrafas.

ent-BoxSterileMask = caixa de máscaras descartáveis
    .desc = Esta caixa contém máscaras descartáveis.
...
ent-BoxBodyBag = caixa de bolsas de necrotério
    .desc = Contém bolsas de necrotério.

ent-BoxVial = caixa de frascos
    .desc = Uma caixa cheia de frascos.

# Science
ent-BoxBeaker = caixa de béqueres
...
ent-ChemicalSynthesisKit = kit de síntese química
    .desc = Um kit inicial para o aspirante a químico. Inclui toxina e vestina para todas as suas necessidades criminosas!

ent-Observationskit = kit de observações
    .desc = Uma caixa de papelão para guardar coisas.
