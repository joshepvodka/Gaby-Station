...
ent-ClothingOuterHardsuitDeathsquad = armadura do esquadrão da morte
    .desc = Uma hardsuit ultra avançada, escolha favorita de exterminadores da NT.

ent-ClothingOuterHardsuitEngineering = armadura de engenharia
    .desc = Um traje espacial que protege o usuário de ambientes perigosos ou despressurizados. Oferece proteção a radiação.

ent-ClothingOuterHardsuitEngineeringWhite = armadura do engenheiro chefe
...
ent-ClothingOuterHardsuitMedical = armadura biológica do médico chefe
...
ent-ClothingOuterHardsuitRd = armadura experimental de pesquisador
...
ent-ClothingOuterHardsuitSalvage = armadura de exploração
...
ent-ClothingOuterHardsuitSecurity = armadura de segurança
    .desc = Um traje espacial que protege o usuário de ambientes perigosos ou despressurizados. Tem uma camada extra de blindagem

ent-ClothingOuterHardsuitSecurityRed = armadura do segurança chefe
    .desc = Um traje espacial que protege o usuário de ambientes perigosos ou despressurizados. Tem uma camada extra de blindagem

ent-ClothingOuterHardsuitSyndie = armadura do Sindicato
    .desc = Uma hardsuit extremamente blindada e ágil planejada para operações espaciais.

ent-ClothingOuterHardsuitWizard = armadura de arcana
    .desc = Um traje bizarro moldado em jóias que radiam energias mágicas.

ent-ClothingOuterHardsuitLing = armadura bio-orgânica espacial
    .desc = Um traje espacial feito com biomassa, resistente a despressurização e baixas temperaturas. 100% vegano!

ent-ClothingOuterHardsuitSpatio = armadura de espaçonauta
...
ent-ClothingOuterHardsuitJuggernaut = armadura Ultra-Blindada Cybersun
    .desc = A suit made by the cutting edge R&D department at cybersun to be hyper resilient.

ent-ClothingOuterHardsuitSyndieCommander = armadura de comandante do Sindicato
    .desc = Uma hardsuit altamente modificada, planejada exclusivamente para o comandante das operações espaciais.

ent-ClothingOuterHardsuitSyndieElite = armadura de elite do Sindicato
...
ent-ClothingOuterHardsuitERTLeader = armadura de líder da ERT
    .desc = Uma hardsuit de proteção utilizada pelos membros do esquadrão da ERT.

ent-ClothingOuterHardsuitERTEngineer = armadura de engenheiro da ERT
    .desc = Uma hardsuit de proteção utilizada pelos membros do esquadrão da ERT.

ent-ClothingOuterHardsuitERTMedical = armadura de paramédico da ERT
    .desc = Uma hardsuit de proteção utilizada pelos membros do esquadrão da ERT.

ent-ClothingOuterHardsuitERTSecurity = armadura de segurança da ERT
    .desc = Uma hardsuit de proteção utilizada pelos membros do esquadrão da ERT.

ent-ClothingOuterHardsuitERTJanitor = armadura de zelador da ERT
    .desc = Uma hardsuit de proteção utilizada pelos membros do esquadrão da ERT.
