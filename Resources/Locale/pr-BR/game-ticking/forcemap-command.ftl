...
forcemap-command-map-not-found = O mapa { $map } não foi encontrado.
forcemap-command-success = Forçando jogo para iniciar com o mapa { $map } no proximo round.
forcemap-command-cleared = Configurações de mapa limpo.
